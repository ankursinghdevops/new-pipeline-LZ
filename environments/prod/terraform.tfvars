...
vnets = {
  vnet1 = {
    name                = "vnet-humana-prod"
    location            = "centralindia"
    resource_group_name = "rg-humana-prod"
...
subnets = {
  snet1 = {
    ...
    resource_group_name  = "rg-humana-prod"
    virtual_network_name = "vnet-humana-prod"
...
vms = {
  frontend_1 = {
    ...
    location        = "centralindia"
    rg_name         = "rg-humana-prod"
    nic_subnet_name = "frontend-subnet-prod"
    nic_vnet_name   = "vnet-humana-prod"
    vm_name         = "frontend-vm-1-prod"
    vm_size         = "Standard_B1s"
    admin_username  = "devopsadmin"
    key_vault_name  = "kv-humana-prod-123"
