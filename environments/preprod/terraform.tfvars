...
vnets = {
  vnet1 = {
    name                = "vnet-humana1-dev"
    location            = "centralindia"
    resource_group_name = "rg-humana1-dev"
...
subnets = {
  snet1 = {
    ...
    resource_group_name  = "rg-humana1-dev"
    virtual_network_name = "vnet-humana1-dev"
...
vms = {
  frontend_1 = {
    ...
    location        = "centralindia"
    rg_name         = "rg-humana1-dev"
    nic_subnet_name = "frontend-subnet-dev"
    nic_vnet_name   = "vnet-humana1-dev"
    vm_name         = "frontend-vm-1-dev"
    vm_size         = "Standard_B1s"
    admin_username  = "devopsadmin"
    key_vault_name  = "kv-humana1-dev-123"
